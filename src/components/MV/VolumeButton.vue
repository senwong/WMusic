  ...
  <svg height="100%" version="1.1" viewBox="0 0 36 36" width="100%" fill="white">
    ...
    <defs>
      <clipPath id="slash-clip">
        <path id="slash-clip-path" ref="slashClipPath" d="M10,0 V36 H36 V0 H0 Z M 9.5,9 l 17,17 -1.8,1.8 -17,-17 1.5,-1.5 Z"></path>
      </clipPath>
      <g id="full-volume-icon"  data-state="full" >
        <path class="main" d="M8,21 L12,21 L17,26 L17,10 L12,15 L8,15 L8,21 Z M19,14 L19,22 C20.48,21.32 21.5,19.77 21.5,18 C21.5,16.26 20.48,14.74 19,14 Z
              ...
              L19,11.29 Z" clip-path="url(#slash-clip)"/>
      ...
      <g id="zero-volume-icon" data-state="zero">
        ...
        <path class="clip" d="M0,0 V36 H36 V0 H0 Z M 9.5,9 l 17,17 -1.8,1.8 -17,-17 1.5,-1.5 Z"></path>
      </g>
    </defs>
  </svg>
</button>
...
export default {
  ...
  methods: {
    ...
    replaceUseEl: function() {
      ...
      select(this.element.querySelector("svg")).select("#slash-clip-path")
